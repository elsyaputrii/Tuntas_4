// FILE: frontend/lib/pdfBorang.ts
// Generator PDF Borang Resmi TUNTAS Polibatam
// Menggantikan borang fisik cetak dengan versi digital berdata nyata
...
export function cetakBorangRegistrasi(data: BorangRegistrasiData): void {
  ...
  const verifikasi = isSelesai ? "1" : "2"; // 1=Sesuai, 2=Perbaikan Berkelanjutan
...
export function cetakBorangRekapitulasi(data: RekapItem[]): void {
  ...
  // Tambah baris kosong kalau data < 12 biar kelihatan seperti borang asli
